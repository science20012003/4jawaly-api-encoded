...
return [
    ...
    'phone' => 'حقل :attribute يحتوي على رقم غير صالح.',
    'custom'               => [
        'attribute-name' => [
    ...
    'attributes'           => [
        "special_discount_linked_account"=>"قيود الخصومات الخاصة",
        "invoice_linked_account"=>"قيود الفواتير",
        "crm_lead_group_id"=>"المجموعة الرئيسية",
        "f_name"=>"الاسم الاول",
        "copy_from"=>"نسخ من ",
        "copy_to"=>"نسخ الى ",
        "w_mobile"=>"   رقم جوال ",
        ...
        "code"=>"رمز",
        "sub_crm_lead_group_id"=>"المجموعة الفرعية",
        "phone_country"=>"رمز الدولة",
        "warnings"=>"تحذير",
        "account_type"=>"نوع الحساب",
        "note"=>"ملاحظة",
        "fund"=>"المبلغ",
        "sms_fees"=>"تكلفه نقطه الرساله العاديه",
        "otp_sms_fees"=>"تكلفه النقطه رساله otp",
        "salla_sms_fees"=>"تكلفه النقطه رساله salla",
        "title.ar"=>"العنوان (عربى)",
        "title.en"=>"العنوان(انجليزى)",
        "details"=>"التفاصيل",
        "journal_module_id"=>"نوع القيد",
        "name_ar"   => "الاسم بالعربى",
        "name_en"    => "الاسم بالانجليزى",
        "currency_id"=>"العملة",
        "cost_center_id"=>"مركز التكلفة",
        "journal_entry"=>"سند القيد",
        "payment_method_id"=>"طريقة السداد",
        "receipt_method_id"=>"طريقة الصرف",
        "account_guide_id"=>"الحساب  ",
        "statement"=>"البيان   ",
        "fees"=>" الرسوم  ",
        "value"=>"القيمة  ",
        "tax_status"=>"حالة الضرائب",
        "taxes"=>"  الضرائب",
