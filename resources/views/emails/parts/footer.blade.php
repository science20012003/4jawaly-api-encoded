...
<tr style="display: none">
    <td align="center" valign="top" style="border-collapse:collapse;">
        ...
        <table border="0" cellpadding="10" cellspacing="0" width="450" id="supportSection" style="background-color:white;font-family:arial;font-size:12px;">
            <tr>
                            ...
                            <td valign="top" width="100%" style="border-collapse:collapse;">
                                ...
                                <div style="text-align: center; color: #c9c9c9;">
                                    <p>Questions? Get your answers here:&nbsp;
                                        <a href="{{ url('/') }}" style="color:#5c6bc0;font-weight:normal;text-decoration:underline; font-size: 12px;">Help Center</a>.</p>
                                </div>
                                <br>
                            </td>
                        </tr>
            ...
            <tr>
                <td valign="top" class="footerContent" style="border-collapse:collapse;background-color:#fafafa;">
                    <div style="text-align:center;color:#505050;font-family:Arial;font-size:11px;line-height:150%;">
                        <p style="margin:0;margin-top:2px;font-family: cursive;">جميع الحقوق محفوظة © فور جوالي لإرسال الرسائل القصيرة
                            {{date("Y")}}</p>
                    </div>
                    <!-- // End Module: Standard Footer \\ -->
                </td>
