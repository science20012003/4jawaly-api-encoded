        ...
        <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
            <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                <h1 class="h1"
                    ...
                    طلب استخدام صلاحية اسم مرسل</h1>
                <h2 class="h1"
                    ...
                    Sender Use Request</h2>
                <p style="margin-bottom: 0; font-weight: 800; font-family: Arial;"> عملينا العزيز {{ $name }}:
                    لقد قام بأرسال دعوه :{{ $user_name }} ﻷستخدام اسم السندر:{{ $sender }} </p>
