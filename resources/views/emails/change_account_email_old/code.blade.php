@include('emails.parts.header')
 ...
 عميلنا العزيز {{$name}} : <br />
                                                            لقد تم تغيير البريد الخاص بك الى {{$to_email}} من خلال التذكرة رقم
                                                            {{$ticket_number}} <br />
                                                         </p>
                                                        <br />
                                                        <p style="margin-top: 0;">
                                                            ...
                                                            You have been requested to change your E-mail to {{$to_email}} through ticket number {{$ticket_number}}
                                                              .</p>
                                                    </div>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="padding-bottom:10px;">
                                                        ...
                                                        <tr align="center">
                                                            <td align="center" valign="middle" style="border-collapse:collapse;">
                                                                <a class="buttonText" href="{{ $callback }}" target="_blank" style="color: #5c6bc0;text-decoration: none;font-weight: normal;display: block;border: 2px solid #5c6bc0;padding: 10px 80px;font-weight: 800; font-family: cursive;">   لست أنا من قام بهذا الاجراء </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
