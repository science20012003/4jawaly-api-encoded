        ...
        <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
            <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                ...
                <h2 class="h1"
                    ...
                    SMS verification</h2>
                <p style="margin-bottom: 0; font-weight: 800; font-family: Arial;text-align: right;"> عملينا العزيز <?php echo e($account->name); ?>:
                    تم ارسال رسالة من المستخدم الفرعى الذى بياناته كالتالي<br>
                    الاسم:<?php echo e($sub_account->name); ?> <br >
                    رقم الجوال:<?php echo e($sub_account->mobile); ?> <br />
                    تفاصيل الارسالية:<br>
                    نوع الارسالية:<?php echo e($text_array["type_txt"]); ?><br />
                    عدد الارقام المرسل اليها:<?php echo e($text_array["numbers"]); ?><br />
                    نص الرسالة:
                    <?php echo e($text_array["text"]); ?>
                    ...
                    <tr align="center">
                        <td align="center" valign="middle" style="border-collapse:collapse;">
                            <div style="display: inline-block;">
                                <a class="buttonText" href="<?php echo e($accept); ?>" target="_blank"
                                    ...
                                    موافقه </a>
                                <a class="buttonText" href="<?php echo e($cancel); ?>" target="_blank"
...
<?php /**PATH /home/php/resources/views/emails/user_sender/sms.blade.php ENDPATH**/ ?>