    ...
    <tr>
        <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
            <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                ...
                <p style="margin-bottom: 0; font-weight: 800; font-family: cursive;">  عملينا العزيز <?php echo e($name); ?> تم الانتهاء من تصدير الملف

                    <?php if($sub_account instanceof \App\Model\SubAccount): ?>
                        الخاص بالحساب الفرعى رقم <?php echo e($sub_account->mobile); ?>

                    <?php endif; ?>
                    :
                    <br />
               <a href="<?php echo $mmessage; ?>">اضغط هنا للتحميل</a>
                    <br />
                ...
                <br />
                <a href="<?php echo $mmessage; ?>">download from here  </a>
                <br />
...
<?php /**PATH /home/php/resources/views/emails/crmlead/export-success.blade.php ENDPATH**/ ?>