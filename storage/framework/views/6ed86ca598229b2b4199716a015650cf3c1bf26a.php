                                                ...
                                                <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                                                    <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                                                        ...
                                                        <p style="margin-bottom: 0; font-weight: 800; font-family: cursive;">  عملينا العزيز <?php echo e($name); ?>: <br />
                                                            تم طلب تغير رقم الجوال الخاص بك من : <?php echo e($old); ?>  الي: <?php echo e($new); ?> <br />
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="padding-bottom:10px;">
                                                        ...
                                                        <tr align="center">
                                                            <td align="center" valign="middle" style="border-collapse:collapse;">
                                                                <a class="buttonText" href="<?php echo e($callback); ?>" target="_blank" style="color: #5c6bc0;text-decoration: none;font-weight: normal;display: block;border: 2px solid #5c6bc0;padding: 10px 80px;font-weight: 800; font-family: cursive;"> تغيير    الجوال  </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
...
<?php /**PATH /home/php/resources/views/emails/change_account_mobile/code.blade.php ENDPATH**/ ?>