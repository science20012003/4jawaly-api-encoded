                                            ...
                                            <tr>
                                                <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                                                    <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                                                        ...
                                                        <p style="margin-bottom: 0; font-weight: 800; font-family: cursive;">  عملينا العزيز <?php echo e($name); ?>:  برجاء الضغط على الزر التالي لقبول الدعوه </p>
                                                        <p style="margin-top: 0;">Dear client <?php echo e($name); ?>:
                                                            please click the following button to accept invitation .</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" style="padding-bottom:10px;">
                                                        ...
                                                        <tr align="center">
                                                            <td align="center" valign="middle" style="border-collapse:collapse;">
                                                                <a class="buttonText" href="<?php echo e($callback); ?>" target="_blank" style="color: #5c6bc0;text-decoration: none;font-weight: normal;display: block;border: 2px solid #5c6bc0;padding: 10px 80px;font-weight: 800; font-family: cursive;"> قبول الدعوة </a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
...
<?php /**PATH /home/php/resources/views/emails/account_invitation/code.blade.php ENDPATH**/ ?>